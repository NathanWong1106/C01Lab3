...
function Dialog({open, initialNote, closeDialog, postNote: postNoteState, patchNoteState}) {
        ...
        try {
            ...
            .then((res) => {
                if(!res.ok) {
                    ...
                    console.log("Patch failed: ", res.status)
                } else {
            ...
            console.log("Patch Note function failed: ", error);
        }
    }
